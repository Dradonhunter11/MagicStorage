...
namespace MagicStorage.Components
{
    public class StorageConnector : ModTile
    {
        ...
        public int CanPlace(int i, int j, int type, int style, int direction, int unused)
        {
            int count = 0;
        ...
        public static int Hook_AfterPlacement(int i, int j, int type, int style, int direction, int unused)
        {
            if (Main.netMode == 1)
            {
